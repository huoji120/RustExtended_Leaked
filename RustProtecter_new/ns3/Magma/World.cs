namespace Magma
{
    ...
    public class World
    {
        ...
        public StructureMaster CreateSM(Magma.Player p)
        {
            return this.CreateSM(p, p.X, p.Y, p.Z, p.PlayerClient.transform.rotation);
        }

        public StructureMaster CreateSM(Magma.Player p, float x, float y, float z)
        {
        ...
        public object SpawnAtPlayer(string prefab, Magma.Player p)
        {
        ...
        public System.Collections.Generic.List<Entity> Entities
        {
            get
            {
                ...
                foreach (StructureComponent component in UnityEngine.Resources.FindObjectsOfTypeAll(typeof(StructureComponent)))
                {
                    list.Add(new Entity(component));
                }
                foreach (DeployableObject obj2 in UnityEngine.Resources.FindObjectsOfTypeAll(typeof(DeployableObject)))
                {
