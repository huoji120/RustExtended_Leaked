...
namespace RustExtended
{
	public class Hooks
	{
		...
		{
            RustExtended.RustHook.RustSteamServer_UpdateServerTitle();

        }
		public static void RustSteamServer_OnPlayerCountChanged()
		{
            RustExtended.RustHook.RustSteamServer_OnPlayerCountChanged();

        }
		public static void ServerInit_Initialized()
		{
            RustExtended.RustHook.ServerInit_Initialized();

		}
		public static void ServerSaveManager_Save(string path)
		{
            RustExtended.RustHook.ServerSaveManager_Save(path);
		...
		public static void Chat_Say(ref ConsoleSystem.Arg arg)
		{
            ...
            RustExtended.RustHook.Chat_Say(ref arg);
		...
		public static void Global_Say(ref ConsoleSystem.Arg arg)
		{
            ...
            RustExtended.RustHook.Global_Say(ref arg);
			arg = (ConsoleSystem.Arg)array[0];
		}
        ...
        public static int uLink_DoNetworkRecv(System.Net.Sockets.Socket socket, ref byte[] buffer, ref EndPoint ip)
		{
			try
			{
                ...
                int result;
                if (!Hooks.NetworkBlacklistIP.Contains(ip) && num >= 16)
				{
                    long num3 = BitConverter.ToInt64(buffer, 8);
					...
					if (num2 != 8242523046020120583uL)
					{
						...
						{
							Debug.LogWarning("HAVE HACKER[" + ip + "] use DDOS.");
							Hooks.NetworkBlacklistIP.Add(ip);
