    ...
    public class Config
    {
        ...
        public static void Initialize()
        {
            ...
            if (Initialized)
            {
                ...
                Get("SERVER", "Player.Teleport.Method", ref Core.PlayerTeleportMethod, true);
                ...
                Get("SERVER", "Truth.KillAimBot", ref Truth.KillAimBot, true);
                ...
                Get("SERVER", "RustProtect.TwoHash", ref Truth.TwoRustProtectHash, true);
                ...
                Truth.TwoProtectionHash = Truth.TwoRustProtectHash.ToInt32();
                ...
                Magma.Bootstrap.Start();
                if (Truth.RustProtect)
                {
                    Helper.Log("---------------------------------------------------", true);
                    Helper.Log("Rust Anti Cheat By Huoji,QQ1296564236 Ver is 1.0.2.", true);
                    Helper.Log("Do not forget give a RustProtect files for players.", true);
                    Helper.Log("The Protect Hash Is " + Truth.RustProtectHash);
                    Helper.Log("The Protect Hash_2 Is " + Truth.TwoRustProtectHash);
                    Helper.Log("The Protect Key Is " + Truth.RustProtectKey);
                    Helper.Log("---------------------------------------------------", true);
                }
