namespace RustProtect
{
    ...
    public class Protection : MonoBehaviour
    {
        ...
        private static long smethod_2(object object_0, string string_5)
        {
            return smethod_4(object_0, (long) object_0.Length, string_5);
        }

        private static long smethod_3(object object_0, object object_1)
        {
            return smethod_5(object_0, (long) object_0.Length, object_1);
        }

        private static long smethod_4(object object_0, long long_0, string string_5)
        {
            int num = 0;
        ...
        private static long smethod_5(object object_0, long long_0, object object_1)
        {
