...
public class DlqMysql
{
	...
	public class Field
	{
		...
		public DlqMysql.FieldFlags Flags;

		public uint Decimals;

		public uint Charset;

		public DlqMysql.FieldTypes Type;

		public bool IsAutoIncrement
		{
			get
			{
				return !(this.Flags & DlqMysql.FieldFlags.AUTO_INCREMENT_FLAG).Equals(0);
			}
		}
		...
		public bool IsPrimaryKey
		{
			get
			{
				return !(this.Flags & DlqMysql.FieldFlags.PRI_KEY_FLAG).Equals(0);
			}
		}
		...
		public bool IsNotNull
		{
			get
			{
				return !(this.Flags & DlqMysql.FieldFlags.NOT_NULL_FLAG).Equals(0);
			}
		}
		...
		public bool IsNumber
		{
			get
			{
				return !(this.Flags & DlqMysql.FieldFlags.NUM_FLAG).Equals(0);
			}
		}
		...
		public bool IsBinary
		{
			get
			{
				return !(this.Flags & DlqMysql.FieldFlags.BINARY_FLAG).Equals(0);
			}
		}
		...
		public bool IsBlob
		{
			get
			{
				return !(this.Flags & DlqMysql.FieldFlags.BLOB_FLAG).Equals(0);
			}
		}
		...
		public bool IsEnum
		{
			get
			{
				return !(this.Flags & DlqMysql.FieldFlags.ENUM_FLAG).Equals(0);
			}
		}
		...
		public bool IsSet
		{
			get
			{
				return !(this.Flags & DlqMysql.FieldFlags.SET_FLAG).Equals(0);
			}
		}
	}
	...
	public class Record
	{
		...
		private DlqMysql.Field _Field;

		public DlqMysql.Field Field
		{
			get
			{
				return this._Field;
		...
		public Record(DlqMysql.Field field, string value)
		{
			this._Field = field;
			this.Data = value;
		}
	...
	public class Row
	{
		private Dictionary<string, DlqMysql.Record> Record;

		private DlqMysql.Result Result;
		...
		public List<DlqMysql.Record> Get()
		{
			return new List<DlqMysql.Record>(this.Record.Values);
		}

		public DlqMysql.Record Get(string field_name)
		{
			DlqMysql.Record result;
	...
	public class Result
	{
		public List<DlqMysql.Field> Field = new List<DlqMysql.Field>();

		public List<DlqMysql.Row> Row = new List<DlqMysql.Row>();
	...
	public static DlqMysql.LogLevelType LogLevel = DlqMysql.LogLevelType.ERRORS;

	public static MySQL Singleton
	{
		get
		{
			return DlqMysql.Instance;
		}
	}
	...
	public static bool Connected
	{
		get
		{
			return DlqMysql.IsConnected = (DlqMysql.SQL != IntPtr.Zero && DlqMysql.mysql_ping(DlqMysql.SQL) == 0);
		}
	}
	...
	public static bool Queued
	{
		get
		{
			return DlqMysql.SQL != IntPtr.Zero && DlqMysql.Queue.Count > 0;
		}
	}
	...
	public static uint ErrorCode
	{
		get
		{
			...
			{
				result = DlqMysql.mysql_errno(DlqMysql.SQL);
			}
			else
			{
				result = 0u;
	...
	[DllImport("libmysql.dll", SetLastError = true)]
	internal static extern int mysql_options(IntPtr mysql, DlqMysql.MySqlOption option, IntPtr arg);
	...
	public DlqMysql()
	{
		DlqMysql.Charset = "latin1";
		DlqMysql.Host = "127.0.0.1";
		DlqMysql.Port = 3306u;
	}
