namespace Magma
{
    ...
    public class Player
    {
        ...
        public static Magma.Player FindByGameID(string uid)
        {
        ...
        public static Magma.Player FindByName(string name)
        {
            foreach (Magma.Player player in Magma.Server.GetServer().Players)
            {
                if (player.Name == name)
        ...
        public static Magma.Player FindByNetworkPlayer(uLink.NetworkPlayer np)
        {
            foreach (Magma.Player player in Magma.Server.GetServer().Players)
            {
        ...
        public static Magma.Player FindByPlayerClient(PlayerClient pc)
        {
            foreach (Magma.Player player in Magma.Server.GetServer().Players)
            {
        ...
        public static Magma.Player FindBySteamID(string uid)
        {
            foreach (Magma.Player player in Magma.Server.GetServer().Players)
            {
        ...
        {
            Magma.Hooks.OnPlayerKilled += new Magma.Hooks.KillHandlerDelegate(this.Hooks_OnPlayerKilled);
        }
        ...
        {
            this.SendCommand("chat.add " + Facepunch.Utility.String.QuoteSafe(Magma.Server.GetServer().server_message_name) + " " + Facepunch.Utility.String.QuoteSafe(arg));
        }
        ...
        public RustExtended.UserData Data
        {
            get
            {
                return RustExtended.Users.GetBySteamID(this.ourPlayer.netUser.userID);
            }
        }
