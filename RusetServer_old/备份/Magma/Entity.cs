namespace Magma
{
    ...
    public class Entity
    {
        ...
        public System.Collections.Generic.List<Entity> GetLinkedStructs()
        {
            ...
            {
                if (!component.Equals(this.Object))
                {
        ...
        public Magma.Player Creator
        {
            get
            {
                return Magma.Player.FindByGameID(this.CreatorID.ToString());
            }
        }
        ...
        public Magma.Player Owner
        {
            get
            {
                return Magma.Player.FindByGameID(this.OwnerID.ToString());
            }
        }
